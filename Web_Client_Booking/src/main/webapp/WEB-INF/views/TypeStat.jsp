  ...
  function drawChart() {
    function draw(type, title) {
        var charBlock = document.getElementById(type),
                chart = new google.visualization.PieChart(charBlock),
                tr = charBlock.getAttribute("value").split(",");
        data = new google.visualization.DataTable();
        data.addColumn('string', 'Type room');
        data.addColumn('number', 'Count room');
    ...
    draw("chart", "Статистика по количеству номеров в отеле");
  }
</script>
<div class="container">
